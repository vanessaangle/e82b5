...
<html lang="en">
  <head>
    ...
    <title>Desa Riang Gedee</title>

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{asset('home')}}/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{asset('home')}}/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{asset('home')}}/css/line-icons.css">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar indigo">
        <div class="container">
          ...
          <div class="navbar-header">
            <a href="index.html" class="navbar-brand"><img class="img-fulid" src="{{asset('home')}}/img/logo.png" alt=""></a>
          ...
          <div class="collapse navbar-collapse" id="main-navbar">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#services">Profil Desa</a>
              </li>
              <li class="nav-item">
        ...
        <div class="row justify-content-md-center">
          <div class="col-md-10">
            <div class="contents text-center">
              <h1 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0.3s">Desa Riang Gede</h1>
              <p class="lead  wow fadeIn" data-wow-duration="1000ms" data-wow-delay="400ms">Kabupaten Tabanan </p>
    ...
    <section id="services" class="section">
      <div class="container">
        <div class="section-header">          
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Profil Desa Riang Gede</h2>
          ...
          <div id="portfolio" class="row">
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development print">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="{{asset('home')}}/img/portfolio/img1.jpg" alt="" />  
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix design print">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="{{asset('home')}}/img/portfolio/img2.jpg" alt="" />  
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="{{asset('home')}}/img/portfolio/img3.jpg" alt="" />  
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development design">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="{{asset('home')}}/img/portfolio/img4.jpg" alt="" />  
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix development">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="{{asset('home')}}/img/portfolio/img5.jpg" alt="" />  
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mix print design">
              <div class="portfolio-item">
                <div class="shot-item">
                  <img src="{{asset('home')}}/img/portfolio/img6.jpg" alt="" />  
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="{{asset('home')}}/img/team/team1.jpg" alt="">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="{{asset('home')}}/img/team/team2.jpg" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img src="{{asset('home')}}/img/team/team3.jpg" alt="">
              <div class="team-details">
                <div class="team-inner">                  
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <img class="img-fulid" src="{{asset('home')}}/img/team/team4.jpg" alt="">
              <div class="team-details">
                <div class="team-inner">
          ...
          <div class="col-md-12">
            <div class="touch-slider owl-carousel owl-theme">
              <div class="testimonial-item">
                <img src="{{asset('home')}}/img/testimonial/customer1.jpg" alt="Client Testimonoal" />
              ...
              <div class="testimonial-item">
                <img src="{{asset('home')}}/img/testimonial/customer2.jpg" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. send do <br> adipisicing ciusmod tempor incididunt ut labore et</p>
                  <h3>Oidila Matik</h3>
              ...
              <div class="testimonial-item">
                <img src="{{asset('home')}}/img/testimonial/customer3.jpg" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. send do <br> adipisicing ciusmod tempor incididunt ut labore et</p>
                  <h3>Alex Dattilo</h3>
              ...
              <div class="testimonial-item">
                <img src="{{asset('home')}}/img/testimonial/customer4.jpg" alt="Client Testimonoal" />
                <div class="testimonial-text">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. send do <br> adipisicing ciusmod tempor incididunt ut labore et</p>
                  <h3>Paul Kowalsy</h3>
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{asset('home')}}/img/blog/img1.jpg" alt="">
                </a>                
              </div>
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{asset('home')}}/img/blog/img2.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <div class="meta-tags">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{asset('home')}}/img/blog/img3.jpg" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <div class="meta-tags">
    ...
    <script src="{{asset('home')}}/js/jquery.mixitup.js"></script>
    ...
    <script src="{{asset('home')}}/js/scrolling-nav.js"></script>    
